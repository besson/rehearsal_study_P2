...
public class InteractiveGuidePortTypeInterceptorSCAIntent
extends org.ow2.frascati.tinfi.TinfiComponentInterceptor<eu.choreos.api.InteractiveGuidePortType>
implements eu.choreos.api.InteractiveGuidePortType,org.objectweb.fractal.julia.Interceptor {

  private static java.lang.reflect.Method[] METHODS;
  public InteractiveGuidePortTypeInterceptorSCAIntent()  {
  }

  private InteractiveGuidePortTypeInterceptorSCAIntent(Object obj)  {
  ...
  public Object clone()  {
    InteractiveGuidePortTypeInterceptorSCAIntent clone = new InteractiveGuidePortTypeInterceptorSCAIntent(getFcItfDelegate());
    initFcClone(clone);
  ...
  public java.lang.String getFlightAndCarParkLocation(final java.lang.String arg0)  {
    ...
    try {
      if( handlers.size() == 0 ) {
        ...
        org.ow2.frascati.tinfi.IntentJoinPointImpl<eu.choreos.api.InteractiveGuidePortType> ijp = new org.ow2.frascati.tinfi.IntentJoinPointImpl();
  ...
  static  {
    try {
      METHODS = new java.lang.reflect.Method[]{
        eu.choreos.api.InteractiveGuidePortType.class.getMethod("getFlightAndCarParkLocation",java.lang.String.class),
        eu.choreos.api.InteractiveGuidePortType.class.getMethod("setCarParkInfo",eu.choreos.CarParkEntry.class),
        eu.choreos.api.InteractiveGuidePortType.class.getMethod("calculateLocations",java.lang.String.class),
      };
    }
